...
CSV.write(joinpath(base_dir, "g_GBC.csv"), DataFrame(z=z_grid, g=g_pos))
...
CSV.write(joinpath(base_dir, "IBS_GBC.csv"), DataFrame(Method=["Nonlinear", "CoxPH"], IBS=[mean(IBS_nonlinear), mean(IBS_coxph)]))
